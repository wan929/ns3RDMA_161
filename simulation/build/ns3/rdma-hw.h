...
public:
	...
	int ReceiveNotify(Ptr<Packet> p, CustomHeader &ch);
	...
	//void AckTimeoutRetransmit(Ptr<RdmaQueuePair> qp, uint32_t seq);
	//void LastDataTimeoutRetransmit(Ptr<RdmaQueuePair> qp, uint32_t seq);
	...
	Ptr<Packet> GetPrbPacket(Ptr<RdmaQueuePair> qp); //get probe packet
	void SLR_Probe(Ptr<RdmaQueuePair> qp);
	/******************************
