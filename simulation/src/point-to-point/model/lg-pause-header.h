...
#ifndef LG_PAUSE_HEADER_H
#define LG_PAUSE_HEADER_H
...
class LGPauseHeader : public Header
{
public:
  LGPauseHeader (uint16_t lgtype, uint8_t qindex);
  LGPauseHeader ();
  virtual ~LGPauseHeader ();

//Setters
  void SetType (uint16_t _lgtype);
  void SetQIndex (uint8_t _qindex);
