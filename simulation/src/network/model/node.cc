...
Node::Construct (void)
{
  ...
  end_time = 0;
  total_bytes = 0;
  data_hash_conflict_number = 0;
  NACK_hash_conflict_number = 0;
  filter_data_number = 0;
  filter_notify_number = 0;
  filter_NACK_number = 0;
  timeout_number = 0;
  seq_expected_number = 0;

  udp_lost_number = 0;
  ack_lost_number = 0;
  last_udp_lost_number = 0;
  last_ack_lost_number = 0;
  nack_lost_number = 0;
  FB_lost_number = 0;
  total_lost_number = 0;
  ...
  udp_find_number = 0;
  ack_find_number = 0;
  last_udp_find_number = 0;
  last_ack_find_number = 0;
  nack_find_number = 0;
  FB_find_number = 0;
  total_find_number = 0;
...
/*
  ...
  aon = 0;
  tempseq = 0;
  down_received_but_invaild_highest_seq = 0;
 	up_has_sent_highest_seq = 0;
  tempparam = 0;
	mm_flag = true;
  for(uint32_t i = 0; i < 257; i++)
  {
...
void Node::SendNotifyToSender(uint32_t m_index, uint16_t left, uint16_t right)
{

}

void Node::UpdateReTxReqs(uint32_t m_index, uint16_t left, uint16_t right)
{

}

void Node::EnReorderingQueue(Ptr<Packet> p, uint16_t port)
{

}

uint16_t Node::GeSeqnumber(uint16_t PortIndex)
{

}
uint16_t Node::GetPendingack(uint16_t PortIndex)
{

}
bool Node::ToIsSwitch(uint32_t pidx)
{
