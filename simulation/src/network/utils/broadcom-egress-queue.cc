...
// 			if (!found)
// 			{
// 				// for (qIndex = 1; qIndex <= (qCnt-1); qIndex++)
// 				// {
// 				// 	if (!paused[(qIndex + m_rrlast) % (qCnt-1)] && m_queues[(qIndex + m_rrlast) % (qCnt-1)]->GetNPackets() > 0)  //round robin
// 				// 	{
// 				// 		found = true;
// 				// 		break;
// 				// 	}
// 				// }
// 				// qIndex = (qIndex + m_rrlast) % (qCnt-1);
// //mine
// 				if(m_queues[3]->GetNPackets() > 0){
// 					found = true;
// 					qIndex = 3;
// 				}else if(m_queues[7]->GetNPackets() > 0){
// 					found = true;
// 					qIndex = 7;
// 				}
// 			}
...
// 			// p->PeekHeader(ch);
// 			// if(ch.l3Prot == 0x11 || ch.l3Prot == 0xFC || ch.l3Prot == 0xFD || ch.l3Prot == 0xFB) //udp,ack,nack，FB后都检查是否发empty p
// 			// {
// 			// 	emptylast = 0;
// 			// 	normallast = 1;
// 			// }
...
// 			// CustomHeader ch(CustomHeader::L2_Header | CustomHeader::L3_Header | CustomHeader::L4_Header);
// 			// p->PeekHeader(ch);
// 			// if(ch.l3Prot == 0x11 || ch.l3Prot == 0xFC) //udp,ack,nack，FB后都检查是否发empty p
// 			// {
// 			// 	emptylast = 0;
// 			// 	normallast = 1;
// 			// }
...
// 		{
// //n
// 			// if(emptylast == 0 && normallast == 1) //only one
// 			// {
// 			// 	if(m_queues[7]->GetNPackets() > 0) //lowest prio
// 			// 	{
// 			// 		Ptr<Packet> p = m_queues[7]->Dequeue();
// 			// 		m_traceBeqDequeue(p, 7);
// 			// 		m_bytesInQueueTotal -= p->GetSize();
// 			// 		m_bytesInQueue[7] -= p->GetSize();
// 			// 		m_qlast = 7;
...
// //r
// 			//if(emptylast == 0 && (normallast == 1 || normallast == 0)) //only one
// 			// {
// 			// 	if(m_queues[7]->GetNPackets() > 0) //lowest prio
// 			// 	{
// 			// 		//std::cout << "ep" << std::endl;
